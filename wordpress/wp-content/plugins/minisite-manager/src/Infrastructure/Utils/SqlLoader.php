...
class SqlLoader
{
     ...
     */
    public static function loadAndExecute(\wpdb $wpdb, string $sqlFilePath, array $variables = []): void
    {
        ...
        $processedSql = self::replaceVariables($sql, $variables);
     ...
     * @throws \InvalidArgumentException If SQL file doesn't exist
     */
    public static function loadAndProcess(string $sqlFilePath, array $variables = []): string
    {
        $fullPath = self::getFullPath($sqlFilePath);
