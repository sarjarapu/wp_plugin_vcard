...
class NewMinisiteRenderer
{
    ...
    private function prepareTemplateData(object $newMinisiteData): array
    {
        ...
        return [
            ...
            'contact_lat' => isset($mockProfile->geo) && $mockProfile->geo && method_exists($mockProfile->geo, 'getLat')
                ? $mockProfile->geo->getLat() : '',
            'contact_lng' => isset($mockProfile->geo) && $mockProfile->geo && method_exists($mockProfile->geo, 'getLng')
