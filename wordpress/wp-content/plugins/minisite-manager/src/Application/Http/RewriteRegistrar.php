...
final class RewriteRegistrar
{
    public function register(): void
    {
        ...
        add_rewrite_rule('^account/sites/([a-f0-9]{32})/edit/([0-9]+|latest)/?$', 'index.php?minisite_account=1&minisite_account_action=edit&minisite_site_id=$matches[1]&minisite_version_id=$matches[2]', 'top');
        add_rewrite_rule('^account/sites/([a-f0-9]{32})/edit/?$', 'index.php?minisite_account=1&minisite_account_action=edit&minisite_site_id=$matches[1]', 'top');
        add_rewrite_rule('^account/sites/([a-f0-9]{32})/preview/([0-9]+|current)/?$', 'index.php?minisite_account=1&minisite_account_action=preview&minisite_site_id=$matches[1]&minisite_version_id=$matches[2]', 'top');
        add_rewrite_rule('^account/sites/([a-f0-9]{32})/versions/?$', 'index.php?minisite_account=1&minisite_account_action=versions&minisite_site_id=$matches[1]', 'top');
    }
}
