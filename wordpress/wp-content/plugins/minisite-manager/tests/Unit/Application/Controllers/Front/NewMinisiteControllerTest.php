...
final class NewMinisiteControllerTest extends TestCase
{
    ...
    public function testHandleCreateWithEmptyBusinessName(): void
    {
        ...
        // Mock repository to return null for slug generation
        $this->mockMinisiteRepository
            ->expects($this->once())
            ->method('findBySlugs')
            ->willReturn(null);
    ...
    public function testHandleCheckSlugAvailabilityWithExistingMinisite(): void
    {
        ...
        // Mock repository to return existing minisite
        $existingMinisite = new Minisite(
            id: 'existing-id',
        ...
        $this->mockMinisiteRepository
            ...
            ->with('existing-business', 'existing-location')
    ...
    public function testHandleCheckSlugAvailabilityWithAvailableSlug(): void
    {
        ...
        $_SERVER['REQUEST_METHOD'] = 'POST';
        $_POST['nonce'] = 'valid_nonce';
        $_POST['business_slug'] = 'available-business';
        $_POST['location_slug'] = 'available-location';

        // Mock repository to return null (no existing minisite)
        $this->mockMinisiteRepository
            ->expects($this->once())
            ->method('findBySlugParams')
            ->with('available-business', 'available-location')
            ->willReturn(null);
    ...
    public function testHandlePublishWithDraftMinisiteNotFound(): void
    {
        ...
        // Mock repository to return null (minisite not found)
        $this->mockMinisiteRepository
            ->expects($this->once())
            ->method('findById')
            ->with('nonexistent-id')
    ...
    {
        $this->markTestSkipped('Requires complex authorization flow testing - better suited for integration tests');
    }
    ...
    {
        $this->markTestSkipped('Requires complex WooCommerce mocking - better suited for integration tests');
    }
    ...
    {
        $this->markTestSkipped('Requires complex WooCommerce and database mocking - better suited for integration tests');
    }
