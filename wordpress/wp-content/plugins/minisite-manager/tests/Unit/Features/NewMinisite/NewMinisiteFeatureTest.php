...
namespace Tests\Unit\Features\NewMinisite;

use Minisite\Features\NewMinisite\NewMinisiteFeature;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\TestCase;

/**
 * Unit tests for NewMinisiteFeature
 */
#[CoversClass(NewMinisiteFeature::class)]
final class NewMinisiteFeatureTest extends TestCase
{
    ...
    {
        $reflection = new \ReflectionClass(NewMinisiteFeature::class);
    ...
    {
        $this->assertTrue(method_exists(NewMinisiteFeature::class, 'initialize'));
        $this->assertTrue(is_callable([NewMinisiteFeature::class, 'initialize']));
    }
    ...
    public function test_initialize_can_be_called(): void
    {
        ...
        // Mock $wpdb global (required by NewMinisiteHooksFactory)
        global $wpdb;
        if (! isset($wpdb)) {
            $wpdb = $this->createMock(\wpdb::class);
        }

        // Mock repositories in global (required by NewMinisiteHooksFactory)
    ...
    /**
     * Test NewMinisiteFeature class has no constructor
     */
